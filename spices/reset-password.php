...
if(isset($_POST["email"]) && isset($_POST["action"]) && ($_POST["action"]=="update"))
{
	...
	else
	{
        ...
        echo '<div class="error"><p>Congratulations! Your password has been updated successfully.</p><p><a href="https://www.allphptricks.com/forgot-password/login.php"> Click here</a> to Login.</p></div><br />';
    } 
}
?>