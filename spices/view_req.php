...
$query="SELECT * FROM requirements WHERE customer_id = '$customer_id'";
$res=$con->query($query);
?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <a href="requirements.php" class="create-contact">Add requirement</a>
                        ...
                        <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="actions">
                    <a href="update_req.php?req_id=<?=$rows['req_id']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                    <a href="delete_req.php?req_id=<?=$rows['req_id']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                </td>  
                                </tr>
                        <?php
                        }
