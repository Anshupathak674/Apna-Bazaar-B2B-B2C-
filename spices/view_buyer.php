    ...
    <h2>Buyers</h2>
                    ...
                    <tbody>
                        <?php
                            ...
                            {
                                $buyer_id = $rows['customer_id'];
                                $sql = "SELECT name, email, contact FROM customer WHERE customer_id = '$buyer_id'";
                                $res1 = $con->query($sql);
                                while($rows1 = $res1->fetch_assoc())
                                {
                            ?>
                                <tr>
                                    <td><a href="show1.php?id=<?=$buyer_id?>"><?php echo $buyer_id ?></td>
                                    <td><?php echo $rows1['name']; ?></td>
                                    <td><?php echo $rows1['email']; ?></td>
                                    <td><?php echo $rows1['contact']; ?></td>
                                    <td><?php echo "Active"; ?></td>
                                    <td class="actions">
                    <a href="del_buyer.php?id=<?=$buyer_id?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                </td>  
                                </tr>
                        <?php
                        }
