...
<!--                         <h1 class="h3 mb-4 text-gray-800">Post Requirements</h1>
 -->                            <div class="col-lg-7">
                                <div class="p-5">
                                    <center>
                                <form class="user" action="req_pro.php" method="post">
                                    <div class="form-group">
                                        <h3><center>Requirement Details</center></h3>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group row"> 
                                         <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user"
                                                id="contact" name="contact" placeholder="Phone">
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <input type="submit" class="btn btn-primary btn-user btn-block" name="ok" value="Post Requirement">     
                                </form>
                            </center>
                            </div>
                        </div>
