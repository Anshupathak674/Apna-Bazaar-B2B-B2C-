...
$query1="SELECT customer_id, username, email, password, reg_date, status FROM login WHERE customer_id = '$customer_id'";
$query2="SELECT name, country, skype_id, contact, website, address FROM customer WHERE customer_id = '$customer_id'";
$query3="SELECT * FROM business WHERE customer_id = '$customer_id'";
...
<body>
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <table>
                	<tr>
                        <h2> <center>Profile</center></h2></th>
                    </tr>
                </table>
                <br>
                        ...
                        <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $rows['email']; ?></td>        <td><?php echo $rows['password']; ?></td>
                                    <td><?php echo $rows['reg_date']; ?></td>
                                    <td><?php echo $rows['status']; ?></td>
                                    <td><a href="update_login.php"><button>Update</button></a></td>
                        ...
                        <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $rows['country']; ?></td>      <td><?php echo $rows['skype_id']; ?></td>
                                    <td><?php echo $rows['contact']; ?></td>
                                    <td><?php echo $rows['website']; ?></td>
                                    <td><?php echo $rows['address']; ?></td>
                                    <td><a href="update_customer.php"><button>Update</button></a></td>
                                </tr>
                        <?php
                        }
                        ?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th><center>Primary Business</center></th>
                        ...
                        <?php
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $rows['primary_business']; ?></td> <td><?php echo $rows['company_address']; ?></td>
                                    <td><?php echo $rows['product']; ?></td>
                                    <td><a href="update_business.php"><button>Update</button></a></td>
                                </tr>
                        <?php
                        }
                        ?>
