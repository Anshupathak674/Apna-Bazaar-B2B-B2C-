...
<body>
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <center><h2>Requirements of Buyers</h2></center>
           <div class="content read" style="overflow-x:auto;">
                    ...
                    <tbody>
                        <?php
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $rows1['req_id']; ?></td>
                                    <td><?php echo $rows1['customer_id']; ?></td>
                                    <td><?php echo $rows1['product']; ?></td>
                                    <td><?php echo $rows1['quantity']; ?></td>
                                    <td><?php echo $rows1['unit']; ?></td>
